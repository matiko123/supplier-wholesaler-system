...
$query1 = "SELECT history.*,users.name as seller,products.price,products.name as product_name from history inner join products on products.id=history.product inner join users on products.supplier=users.id where users.role=1 and user=$wholesaler_id";
        ...
        <div class="container"><a class="navbar-brand logo" href="#"><?php echo $wholesaler_name?></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item item"><a class="nav-link active" href="#">Purchase History</a></li>
